...
class TestSolverVariables:
    ...
    def sample_variables(self, model: cp_model.CpModel) -> SolverVariables:
        ...
        for worker_id in ["W001", "W002"]:
            ...
            for period in range(3):
                ...
                for shift_type_id in ["day", "night"]:
                    ...
                    assignment[worker_id][period][shift_type_id] = model.new_bool_var(
                        var_name
                    )
        ...
        for worker_id in ["W001", "W002"]:
            ...
            for shift_type_id in ["day", "night"]:
                ...
                shift_counts[worker_id][shift_type_id] = model.new_int_var(
                    0, 10, var_name
                )
    ...
    def test_get_assignment_var_different_worker(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_get_assignment_var_invalid_worker(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_get_assignment_var_invalid_period(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_get_assignment_var_invalid_shift_type(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_get_shift_count_var_invalid_worker(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_get_shift_count_var_invalid_shift_type(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_get_undesirable_total_var_invalid_worker(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_all_assignment_vars_yields_tuples(
        self, sample_variables: SolverVariables
    ) -> None:
    ...
    def test_get_worker_period_vars_invalid_worker(
        self, sample_variables: SolverVariables
    ) -> None:
